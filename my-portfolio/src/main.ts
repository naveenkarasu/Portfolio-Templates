...
resourceTracker.trackResource(); // DOM content
resourceTracker.trackResource(); // Fonts
resourceTracker.trackResource(); // Three.js background
resourceTracker.trackResource(); // Profile content

// Simulate resource loading for fonts
...
let backgroundScene: BackgroundScene | null = null;
...
// Populate content from profile data
document.addEventListener('DOMContentLoaded', () => {
  resourceTracker.resourceLoaded(); // DOM content loaded
  ...
  resourceTracker.resourceLoaded(); // Profile content loaded

  // Initialize Three.js background after content
  if (canvas) {
    backgroundScene = new BackgroundScene(canvas);
    resourceTracker.resourceLoaded(); // Three.js background loaded
  }

  // Complete loading after a short delay to ensure everything is rendered
  setTimeout(() => {
